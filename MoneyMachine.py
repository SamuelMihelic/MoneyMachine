...
class exe:
    def __init__( self, baseline_proportion, PID_constants, Gaussian_window_length, model_order, exchange_name, historical_data_file, account_data_file, target_asset, benchmark_asset, is_demo, account_credentials ):
        ...
        self.exch = mm.exchange( history_duration, resolution, exchange_name, historical_data_file, account_data_file, target_asset, benchmark_asset, is_demo, account_credentials, baseline_proportion )
        ...
        while True: # infinite loop
            ...
            self.asset_balance = ( self.PID.response + self.base ) * ( self.exch.asset_balance + self.exch.bsset_balance ) # [bsset units]
